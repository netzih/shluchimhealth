...
echo "✓ Created: {$post1['title']} (ID: {$post1Id})\n";
...
echo "✓ Created: {$post2['title']} (ID: {$post2Id})\n";
...
echo "✓ Created: {$post3['title']} (ID: {$post3Id})\n";

echo "\n✅ Successfully created 3 high-quality blog posts!\n";
echo "\nYou can view them at:\n";
echo "- " . SITE_URL . "/blog/\n";
echo "- Admin panel: " . SITE_URL . "/admin/posts.php\n";
